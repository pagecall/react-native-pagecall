...
public class PagecallWebviewModule extends ReactContextBaseJavaModule {
  private static final String REACT_CLASS = "PagecallWebviewViewManager";

  public PagecallWebviewModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }
